...
##################################################################
RGW_USER=${RGW_USER:-s3cmd}
RGW_ACCESSKEY=${RGW_ACCESSKEY:-otwle2cdsa9roj2v}
RGW_SECRET=${RGW_SECRET:-2c6cochuszjf0m75}
RGW_BUCKET=${RGW_BUCKET:-superbkt}
##################################################################
...
## format and add osd
mkfs.xfs /dev/vdb
mkdir -p /var/lib/ceph/osd/osd0
mount /dev/vdb /var/lib/ceph/osd/osd0
